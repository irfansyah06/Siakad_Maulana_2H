        ...
        <div class="card" style="width: 24rem;">
            ...
            <div class="card-body">
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item"><b>Foto: </b><img style="width: 25%" src="{{ asset('./image/'. $Mahasiswa->image) }}" ></li>
                    ...
                    {{-- <li class="list-group-item"><b>Address: </b>{{$Mahasiswa->Address}}</li>
                    <li class="list-group-item"><b>Date Of Birth: </b>{{$Mahasiswa->DateOfBirth}}</li> --}}
                </ul>
            </div>
